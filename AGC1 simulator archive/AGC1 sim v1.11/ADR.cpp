...
bool ADR::GTR_27()
{
	return (register_S.read() > 027); // should be CADR **********************
}

bool ADR::GTR_17()
{
		// check: address is not a central register
	return (register_S.read() > 017); // should be CADR **********************
}

bool ADR::EQU_25()
{
	return (register_S.read() == 025); // should be CADR **********************
}

bool ADR::EQU_14()
{
	return (register_S.read() == 014); // should be CADR **********************
}
...
bool ADR::EQU_16()
{
	...
	return (register_S.read() == 016); // should be CADR **********************
}

bool ADR::GTR_1777()
{
		// check: address is fixed memory
	return (register_S.read() > 01777); // should be CADR **********************
}
