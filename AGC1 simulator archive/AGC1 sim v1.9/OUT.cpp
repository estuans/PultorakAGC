...
{
	BUS::glbl_RWBUS = register_OUT0.read();
}
...
{
	register_OUT0.write(BUS::glbl_RWBUS); 
...
{
	BUS::glbl_RWBUS = register_OUT1.read();
}
...
{
	register_OUT1.write(BUS::glbl_RWBUS);
}
...
{
	BUS::glbl_RWBUS = register_OUT2.read();
}
...
{
	register_OUT2.write(BUS::glbl_RWBUS);
}
...
{
	BUS::glbl_RWBUS = register_OUT3.read();
}
...
{
	register_OUT3.write(BUS::glbl_RWBUS);	
}
...
{
	BUS::glbl_RWBUS = register_OUT4.read();
}
...
{
	register_OUT4.write(BUS::glbl_RWBUS);	
}
