...
void CRG::execRP_RQ()
{
	BUS::glbl_RWBUS |= register_Q.read();
}
...
void CRG::execWP_WQ()
{
	register_Q.write(BUS::glbl_RWBUS);
}
...
void CRG::execRP_RZ()
{
	BUS::glbl_RWBUS |= register_Z.read();
}
...
void CRG::execWP_WZ()
{
	register_Z.write(BUS::glbl_RWBUS);
}
...
void CRG::execRP_RLP()
{
	BUS::glbl_RWBUS |= register_LP.read();
}
...
{
	register_LP.writeShift(BUS::glbl_RWBUS, CRG::conv_WALP_LP);
	register_A.writeShift(BUS::glbl_RWBUS, CRG::conv_WALP_A);
}

void CRG::execWP_WLP()
{
	register_LP.writeShift(BUS::glbl_RWBUS, CRG::conv_WLP);
}
...
void CRG::execRP_RA()
{
	BUS::glbl_RWBUS |= register_A.read();
}
...
void CRG::execWP_WA()
{
	register_A.write(BUS::glbl_RWBUS);
}
