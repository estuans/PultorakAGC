...
EXECTYPE execR[] =
{
	...
	execR_RA14,
	execR_RA,
	execR_NOPULSE, // was RB
	execR_RBK,
	execR_NOPULSE, // was RB14
	execR_NOPULSE, // was RC
	execR_RG,
	execR_RLP,
	execR_NOPULSE,
	execR_NOPULSE,
	execR_RQ,
	execR_RRPA,
	execR_NOPULSE, // was RSB
	execR_NOPULSE,
	execR_RSCT,
	execR_NOPULSE, // was RU
	execR_RZ,
	execR_NOPULSE, // was R1
	execR_NOPULSE, // was R1C
	execR_NOPULSE, // was R2
	execR_NOPULSE, // was R22
	execR_NOPULSE, // was R24
	execR_NOPULSE, // was R2000
	execR_NOPULSE,
	execR_NOPULSE,
	execR_NOPULSE,
	execR_NOPULSE,
...
void CLK::doexecR_ALU_OR(int pulse) { execR_ALU_OR[pulse](); } 
	...
	void execW_GENRST()	{ SEQ::execWP_GENRST(); PAR::execWP_GENRST(); ALU::execWP_GENRST(); CTR::execWP_GENRST(); INT::execWP_GENRST(); OUT::execWP_GENRST(); }
	void execW_GP()		{ PAR::execWP_GP();	OUT::execWP_GP(); }
	void execW_INH()	{ INT::execWP_INH(); }
	void execW_KRPT()	{ INT::execWP_KRPT(); }
	void execW_NISQ()	{ SEQ::execWP_NISQ(); }
	void execW_RPT()	{ INT::execWP_RPT(); }
	void execW_RP2()	{ PAR::execWP_RP2(); OUT::execWP_RP2(); }
